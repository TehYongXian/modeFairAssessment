...
function Inch14Macbook() {
    return (
        ...
        <div className="flex flex-wrap place-content-center">
            ...
            <div className="m-5 p-5 w-72 bg-appleBackgroundGray w-1/4 ">
                ...
                <div className="spec bg-pink-500">
                    <div>
                        <img src={inch14.chipImg} alt="Apple M3 chip" width="51" height="51" class="dd-invert-classic ir"></img>
                    </div>
                    <div className="CoreSpec">
                    ...
                    <div>
                        <h3><strong>Need a momont?</strong></h3>
