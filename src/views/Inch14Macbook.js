        ...
        <div className="max-w-maxW">
            <div className="flex flex-wrap place-content-center">
                {itemList.Macbook["14-inch"].map((inch14) => (
                    <div className="p-2 m-3 bg-appleBackgroundGray rounded-2xl w-full md:w-1/4 ">
                        <img
                            width="452"
                            height="420"
                            alt="14-inch MacBook Pro, open, display, thin bezel, FaceTime HD camera, raised feet, rounded corners, Silver"
                            src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/mbp14-silver-select-202310?wid=904&amp;hei=840&amp;fmt=jpeg&amp;qlt=90&amp;.v=1697230830269"
                        ...
                        <div className="spec">
                            <div className="mt-5">
                                <img src={inch14.chipImg} alt="Apple M3 chip" width="51" height="51" />
                            </div>
                            ...
                            <button className="mt-5 p-1 w-full bg-btnColor rounded-lg text-white" onClick={() => handleButtonClick(inch14.url)}>
                                Select
                            </button>
                            ...
                            <div className="text-left pt-5 px-2 flex flex-row">
                                <div className="p-2">
                                    <svg viewBox="0 0 25 25" role="img" aria-hidden="true" width="25px" height="25px">
                            ...
                            <div className="text-left pt-5 px-2 flex flex-row">
                                <div className="p-2">
                                    <svg viewBox="0 0 25 25" role="img" aria-hidden="true" width="25px" height="25px">
                                        <path fill="none" d="M0 0h25v25H0z"></path>
                                        <path
                                            d="M18.5 5h-1.775a4.231 4.231 0 0 0-8.45 0H6.5A2.5 2.5 0 0 0 4 7.5v11A2.5 2.5 0 0 0 6.5 21h12a2.5 2.5 0 0 0 2.5-2.5v-11A2.5 2.5 0 0 0 18.5 5Zm-6-3a3.245 3.245 0 0 1 3.225 3h-6.45A3.245 3.245 0 0 1 12.5 2ZM20 18.5a1.5 1.5 0 0 1-1.5 1.5h-12A1.5 1.5 0 0 1 5 18.5v-11A1.5 1.5 0 0 1 6.5 6h12A1.5 1.5 0 0 1 20 7.5Z"
                                        ></path>
                                        <path
