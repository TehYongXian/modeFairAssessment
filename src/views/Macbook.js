    ...
    <div className='itemPageContainer max-w-maxW mx-auto'>
      ...
      <div className='buddleOption  text-center'>
        <div className='mx-auto place-content-center my-5'>
          <h1 className='text-4xl'><strong>Choose your new MacBook Pro.</strong></h1>
        </div>
        ...
        <div className='itemPageContainer mt-5'>
          <div className='screenSizeContiner sticky top-0 py-5 bg-appleBackgroundGray bg-opacity-95 w-full'>
            <button
              className={`p-5 border-solid border-black border-2 rounded-bl-2xl rounded-tl-2xl bg-white focus:border-btnColor focus:outline-none ${selectSize === '14-inch' ? 'border-btnColor' : ''}`}
              onClick={() => setSelectSize('14-inch')}
            >
              14-inch
            </button>
            <button
              className={`p-5 border-solid border-black border-b-2 border-r-2 border-t-2 rounded-br-2xl bg-white rounded-tr-2xl focus:border-btnColor focus:outline-none ${selectSize === '16-inch' ? 'border-btnColor' : ''}`}
