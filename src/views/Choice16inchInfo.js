...
function Choice16inchInfo() {
    return (
        <div className="m-2 t-100 p2">
            <div className="title">
            ...
            <div className="flex flex-row m-5 p-5">
                ...
                <img src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/apple-m3-icon-mac-202310?wid=72&amp;hei=72&amp;fmt=png-alpha&amp;.v=1697482680961" alt="" width="36" height="36" class="ir"/>
                    <h3>Apple M3 chip</h3>
                    <p>M3 brings serious speed and capability to blaze through everyday activities, multitask across apps and video calls, and handle elaborate content in pro apps and games</p>
                    <ul>
                ...
                <img src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/apple-m3-pro-icon-mac-202310?wid=72&amp;hei=72&amp;fmt=png-alpha&amp;.v=1696970981318" alt="" width="36" height="36" class="ir"></img>
                    <h3>Apple M3 Pro chip</h3>
                    <p>Building on the M3 chip, M3 Pro provides even greater performance and additional unified memory for more demanding apps and workflows</p>
                    <ul>
                ...
                <img src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/apple-m3-max-icon-mac-202310?wid=72&amp;hei=72&amp;fmt=png-alpha&amp;.v=1696970981319" alt="" width="36" height="36" class="ir"></img>
                    <h3>Apple M3 Max chip</h3>
                    <p>M3 Max powers the most extreme workflows with even more CPU and GPU cores, enormous unified memory and an advanced Media Engine</p>
                    <ul>
                ...
                <img src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/memory-icon-mac-202310?wid=90&amp;hei=72&amp;fmt=png-alpha&amp;.v=1696970981318" alt="" width="45" height="36" class="ir"></img>
                    ...
                    <p>Faster and more efficient than traditional RAM, unified memory is integrated within the M3 family of chips so apps can quickly share data between the CPU, GPU and Neural Engine</p>
                    <ul>
...
export default Choice16inchInfo