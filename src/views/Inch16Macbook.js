    ...
    return (
        ...
        <div className="flex flex-wrap place-content-center ">
            ...
            <div className="p-2 m-3 bg-appleBackgroundGray rounded-2xl w-full md:w-1/4 justify-start">
                ...
                <div className="spec">
                    <div className="mt-5">
                        <img src={inch16.chipImg} alt="Apple M3 chip" width="51" ></img>
                    </div>
                    <div className="CoreSpec text-left pt-5 px-2">
                        <p><strong>{inch16.CPU}</strong></p>
                        <br/>
                        <p><strong>{inch16.GPU}</strong></p>
                        <br/>
                        <p><strong>{inch16.UniMemory}</strong></p>
                        <br/>
                        <p><strong>{inch16.Storage}</strong></p>
                        <br/>
                    </div> 
                    <div className="subSpec text-left px-2">
                        <ul>
                            <li>{inch16.display}</li>
                            <li>{inch16.IO}</li>
                            <li>{inch16.Keyboard}</li>
                            <li>{inch16.trackpad}</li>
                            <li>{inch16.PowerAdapter}</li>
                        </ul>
                    </div>
                    <div className="price text-left pt-5 px-2">
                        <h1><strong>{inch16.Price}</strong></h1>
                        <br/>
                        <p>or</p>
                        <br/>
                        <h1><strong>{inch16.Installment}</strong></h1>
                    </div>
